...
I have chosen below five OWASP-flaws according to **OWASP 2017 top-ten**-list. However, there are other vulnerabilities and/or vulnerability strawmans in the code. I sketched/trialled those during the process but they didn't qualify / end up to my selection of five real flaws/threats. Service is not certified for governmental use yet, i.e. some UI-flows may be incomplete or have occational other bugs.
...
After the installation is completed, the service is accessible in http://127.0.0.1:8000
